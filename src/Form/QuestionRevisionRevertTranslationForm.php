 ...
 * @ingroup equiz
 */
class QuestionRevisionRevertTranslationForm extends QuestionRevisionRevertForm {
  ...
  protected function prepareRevertedRevision(QuestionInterface $revision, FormStateInterface $form_state) {
    ...
    /** @var \Drupal\equiz\Entity\QuestionInterface $default_revision */
    $latest_revision = $this->QuestionStorage->load($revision->id());
